...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            var s1 = new Seller(1, "Bob Brown", "bob@teste.com", new DateTime(1998, 4, 21), 1000.00, d1);
            var s2 = new Seller(2, "Maria Green", "maria@teste.com", new DateTime(1979, 12, 31), 3500.00, d2);
            var s3 = new Seller(3, "Alex Grey", "alex@teste.com", new DateTime(1988, 1, 15), 2200.00, d1);
            var s4 = new Seller(4, "Martha Red", "martha@teste.com", new DateTime(1993, 11, 30), 3000.00, d4);
            var s5 = new Seller(5, "Donald Blue", "donald@teste.com", new DateTime(2000, 1, 9), 4000.00, d3);
            var s6 = new Seller(6, "Scott Pink", "scott@teste.com", new DateTime(1997, 3, 4), 3000.00, d2);
